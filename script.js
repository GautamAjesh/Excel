...
$(document).ready(function () {
    ...
    for (let i = 1; i <= 100; i++) {
        ...
        for (let j = 1; j <= 100; j++) {
            ...
            let column = $(`<div class="input-cell" id="row-${i}-col-${j}" contenteditable="false" data="code-${colCode}"></div>`);
            row.append(column);
        }
            ...
            $(".sheet-rename").click(function () {
                $(".container").append(`<div class="sheet-rename-modal">
                                            ...
                                            <div class="action-buttons">
                                                <div class="rename-button">Rename</div>
